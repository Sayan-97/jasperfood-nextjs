  ...
  return (
    <div className="container flex flex-col items-center gap-12">
      ...
      <p className="text-lg">
        ...
        innovation, and an unwavering dedication to fundamental principles such
        as hygiene, sanitation, quality assurance, excellence, innovation,
        trust, honesty, and community service. JFMPL is not merely a purveyor of
        culinary delights; it is a standard-bearer of responsible and ethical
        business practices, forging a path towards a more sustainable and
        innovative future in the food industry.
      </p>
    </div>
  );
}
