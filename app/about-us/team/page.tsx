export default function Teams() {
  return (
    <div className="container flex flex-col items-center gap-12">
      ...
      <p className="text-lg">
        Our company boasts a team of highly qualified, enthusiastic, and
        creative individuals, including food technologists, microbiologists, and
        ...
        original product concepts, as our company places a strong emphasis on
        research and development (R&D). We also dedicate attention to
